...
//				
//			case "phantom":
//				System.setProperty("phantomjs.binary.path", System.getProperty("user.dir") + "/resource/drivers/phantomjs.exe");
//				driver = new PhantomJSDriver();
//				break;

			default:
				System.setProperty("webdriver.gecko.driver", System.getProperty("user.dir") + "/resource/drivers/chromedriver.exe");
				driver = new FirefoxDriver();
			}
